...
namespace StarChart.Controllers
{
    ...
    public class CelestialObjectController : ControllerBase
    {
        ...
        {
            var existingObject = _context.CelestialObjects.FirstOrDefault(e => e.Id == id);
        ...
        {
            var exist = _context.CelestialObjects.Find(id);
            if (exist == null)
                return NotFound();

            exist.Name = name;

            _context.CelestialObjects.Update(exist);
            _context.SaveChanges();
        ...
        {
            var exists = _context.CelestialObjects.Where(e => e.Id == id || e.OrbitedObjectId == id);
            if (!exists.Any())
                return NotFound();

            _context.CelestialObjects.RemoveRange(exists);
            _context.SaveChanges();
